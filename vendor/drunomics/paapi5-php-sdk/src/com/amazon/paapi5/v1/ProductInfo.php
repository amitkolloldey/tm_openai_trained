...
class ProductInfo implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['color'] = isset($data['color']) ? $data['color'] : 'No Color Availavle';
        $this->container['isAdultProduct'] = isset($data['isAdultProduct']) ? $data['isAdultProduct'] : null;
        $this->container['itemDimensions'] = isset($data['itemDimensions']) ? $data['itemDimensions'] : 'No Dimension Availavle';
        $this->container['releaseDate'] = isset($data['releaseDate']) ? $data['releaseDate'] : 'No Release Date Availavle';
        $this->container['size'] = isset($data['size']) ? $data['size'] : 'No Size Availavle';
        $this->container['unitCount'] = isset($data['unitCount']) ? $data['unitCount'] : 'No Size Availavle';
    }
